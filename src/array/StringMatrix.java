...
public class StringMatrix extends Objects {
    ...
    //Constructors
    public StringMatrix(String[][] array){		
...
//        System.out.println();
		...
		//case not create a matrix with a number of rows equal to the inputed longer row
			...
			this.array = new String[array.length][length[length.length-1]];
    ...
    public String[][] insertLine(String[] elements, int line){
		...
		array = new String[oldArray.length+1][oldArray[0].length];
    ...
    public String[][] insertRow(String[] elements, int row){
		...
		//Save the old values and initialize the new matrix
        String[][] oldArray = array;
        array = new String[oldArray.length][oldArray[0].length+1];
